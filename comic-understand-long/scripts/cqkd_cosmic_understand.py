...
REFERENCE_TOPICS = {
    ...
    "dynamic-object": "references/adv/dynamic-object.md",
    "entity-metadata": "references/adv/entity-metadata.md",
    "flex-prop": "references/adv/flex-prop.md",
    "form-utils": "references/adv/form-utils.md",
    "operate-chain": "references/adv/operate-chain.md",
    "plugin-base": "references/adv/plugin-base.md",
    "query-dataset": "references/adv/query-dataset.md",
    "request-context": "references/adv/request-context.md",
    "view-handler": "references/adv/view-handler.md",
...
REQUIRED_LOCAL_ASSETS = [
    ...
    "references/adv/dynamic-object.md",
    "references/adv/entity-metadata.md",
    "references/adv/query-dataset.md",
    "references/adv/form-utils.md",
    "references/adv/operate-chain.md",
